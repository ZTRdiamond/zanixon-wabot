module.exports = {
    ...
    isOwner: true,
    details: {
        desc: "Menambah limit ke user secara spesifik",
    ...
    code: async(zanixon, m, { zn, sender, text, quoted, isQuoted }) => {
        ...
        if(isQuoted == true) {
            ...
            m.reply(zn.emoji("success") + `︱Berhasil menambah limit user!
...
➭ Limit: *${limit} --> ${limit + parseInt(amount)}*`);
            ...
            m.reply(zn.emoji("alert") + `Balas pesan user atau ketik manual nomor user untuk menambah limit!
